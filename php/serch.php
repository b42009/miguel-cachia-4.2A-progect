...
error_reporting(0);
    ...
    $query = "select eventId,name, eventDate,imagLink from event WHERE imgcategory='1' and eventDate >= CURDATE() and name like '%$inp%' ";
      ...
      echo'<div class="modal-body">';
        echo'<form class="form-inline" method="post" action="loginp.php">';
                ...
                echo  "<input type='text' style='visibility: hidden' value='1' name='cata'>";
                 echo  "<input type='text' style='visibility: hidden' value='$inp' name='serch'>";
             echo'</form>';
      echo"</div>";
...
echo"</div>";
    ...
    <form class="form-inline my-2 my-lg-0" action="serch.php" method="post">
      <input class="form-control mr-sm-2" name='serch'>
