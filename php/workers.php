...
<div class='jumbotron' style='background-color:#808080; width:80%;    margin-left: 10%; margin-top: 2%;'>
         <button  class="btn btn-default" style="margin-left:25vw"><a href="showe.php"><h2>Show Events</h2></a></button><p></p>
         <button  class="btn btn-default" style="margin-left:25vw"><a href="adde.php"><h2>Add Events</h2></a></button><p></p>
         <button  class="btn btn-default" style="margin-left:25vw"><a href="delitw.php"><h2>Delet Events</h2></a></button><p></p>
         <button  class="btn btn-default" style="margin-left:25vw"><a href="changchoos.php"><h2>Chang Events</h2></a></button><p></p>
