...
namespace project
{
    public partial class checkinevent : Form
    {
        string imgc;
        string typen;
        string clientid1;
        public checkinevent(string clientid)
        {
        ...
        private void checkinevent_Load(object sender, EventArgs e)
        {
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            checkinchecker u1 = new checkinchecker(clientid1, ind);
            u1.Show();
            this.Hide();
        }
    }
